...
var Plugins = function () {
  ...
  _createClass(Plugins, [{
    ...
    value: function onProjectAverage(projectReport, pathModule, settings) {
      var event = this._pluginManager.invoke('onProjectAverage', { projectReport: projectReport, pathModule: pathModule, settings: settings }, false);
    ...
    value: function onProjectCalculate(projectReport, pathModule, settings) {
      var event = this._pluginManager.invoke('onProjectCalculate', { projectReport: projectReport, pathModule: pathModule, settings: settings }, false);
      return event !== null ? event.data.projectReport : projectReport;
    }
    ...
    value: function onProjectEnd(projectReport, pathModule, settings) {
      var event = this._pluginManager.invoke('onProjectEnd', { projectReport: projectReport, pathModule: pathModule, settings: settings }, false);
      return event !== null ? event.data.projectReport : projectReport;
    }
    ...
    value: function onProjectPostAverage(projectReport, pathModule, settings) {
      var event = this._pluginManager.invoke('onProjectPostAverage', { projectReport: projectReport, pathModule: pathModule, settings: settings }, false);
      return event !== null ? event.data.projectReport : projectReport;
    }
    ...
    value: function onProjectStart(pathModule, settings) {
      this._pluginManager.invoke('onProjectStart', { pathModule: pathModule, settings: settings }, false);
    }
  }]);
