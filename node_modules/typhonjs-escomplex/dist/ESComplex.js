...
var ESComplex = function () {
   ...
   _createClass(ESComplex, [{
      ...
      value: function analyzeModule(source) {
         ...
         var parserOptions = arguments.length <= 2 || arguments[2] === undefined ? undefined : arguments[2];
      ...
      value: function analyzeProject(sources) {
         ...
         var modules = sources.map(function (source) {
            try {
               return {
                  ast: _Parser2.default.parse(source.code, parserOptions),
      ...
      value: function parse(source) {
         var parserOptions = arguments.length <= 1 || arguments[1] === undefined ? undefined : arguments[1];

         return _Parser2.default.parse(source, parserOptions);
      }
      ...
      value: function analyzeModuleAsync(source) {
         ...
         return new Promise(function (resolve, reject) {
            try {
               resolve(_this.analyzeModule(source, options, parserOptions));
            } catch (err) {
      ...
      value: function parseAsync(source) {
         ...
         return new Promise(function (resolve, reject) {
            try {
               resolve(_this5.parse(source, parserOptions));
            } catch (err) {
               /* istanbul ignore next */reject(err);
            }
         });
